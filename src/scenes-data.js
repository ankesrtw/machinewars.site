...
const SCENE_CONFIGS = {
    ...
    warzone: {
        ...
        previewImage: ASSET_BASE + 'art/zones/warzone.jpg',
    ...
    space: {
        ...
        previewImage: ASSET_BASE + 'art/zones/space.jpg',
        ...
        sky: {
            ...
            // Vacuum: almost no atmospheric scattering, so fog is near-zero.
            fogDensity: 0.003,
            hasLightning: false,
            // CREON — the rogue's relay, read as a dark silhouette against starfield.
            creon: {
                textureUrl: 'art/creon-machine-wars.png',
                tint: [0.85, 0.88, 0.95],
                opacity: 0.9,
        ...
        lighting: {
            // One hard raking sun, minimal bounce — vacuum has no fill light.
            ambientIntensity: 0.18,
            ambientDiffuse: [0.16, 0.18, 0.24],
            ambientGround: [0.03, 0.03, 0.05],
            sunIntensity: 1.15,
            sunDiffuse: [1.0, 0.96, 0.90],
            sunSpecular: [0.55, 0.55, 0.60],
        ...
        ground: {
            ...
            width: 320, height: 320, subdivisions: 96,
            displacementSeed: 41,
            displacementScale: 0.35,
            flatZoneRadius: 30,
            textureUScale: 14, textureVScale: 14,
        ...
        sceneAssets: {
            'rubble_pile':    { file: 'rubble_pile.glb', scale: 5.5, tint: { d: [0.24, 0.27, 0.32], e: [0.05, 0.03, 0.01] }, placements: [
            ...
            'barricade':      { file: 'barricade.glb', scale: 4.5, tint: { d: [0.26, 0.29, 0.34], e: [0.06, 0.035, 0.01] }, placements: [
                { x: -6, z: -4, ry: 0 },    { x: 8, z: -2, ry: 0.2 },
                { x: -14, z: 3, ry: 0.6 },  { x: 16, z: 5, ry: -0.4 },
                { x: -22, z: -10, ry: 1.0 },{ x: 24, z: -8, ry: -0.7 },
            ]},
            'wall_segment':   { file: 'wall_segment.glb', scale: 6.0, tint: { d: [0.23, 0.26, 0.31], e: [0.04, 0.025, 0.01] }, placements: [
                { x: -16, z: -18, ry: 0 },  { x: 18, z: -16, ry: 0.1 },
                { x: -28, z: -6, ry: 0.5 }, { x: 26, z: -4, ry: -0.3 },
                { x: -8, z: -32, ry: 0.15 },{ x: 10, z: -34, ry: -0.1 },
            ]},
            'guard_tower':    { file: 'guard_tower.glb', scale: 11.0, tint: { d: [0.25, 0.28, 0.33], e: [0.06, 0.035, 0.01] }, placements: [
                { x: -38, z: -32, ry: 0 },  { x: 40, z: -30, ry: 0.3 },
                { x: -42, z: 18, ry: 0.8 }, { x: 44, z: 20, ry: -0.5 },
            ]},
            'destroyed_apc':  { file: 'destroyed_apc.glb', scale: 7.0, tint: { d: [0.24, 0.27, 0.32], e: [0.05, 0.03, 0.01] }, placements: [
        ...
        coverColors: { light: [0.28, 0.31, 0.37], dark: [0.17, 0.19, 0.23] },
        ...
        propColors: {
            crate: [0.26, 0.29, 0.34], crateDark: [0.18, 0.20, 0.24],
            barrel: [0.24, 0.26, 0.30], barrelRust: [0.42, 0.26, 0.14], barrelGreen: [0.22, 0.30, 0.28],
            sandbag: [0.30, 0.33, 0.38], pole: [0.24, 0.27, 0.32], wire: [0.20, 0.22, 0.26],
        },
        ...
        // Hull breaches venting burning atmosphere — the amber accent in-scene.
        firePitPositions: [
    ...
    mars: {
        ...
        previewImage: ASSET_BASE + 'art/zones/mars.jpg',
    ...
    alien: {
        ...
        previewImage: ASSET_BASE + 'art/zones/alien.jpg',
    ...
    desert: {
        ...
        previewImage: ASSET_BASE + 'art/zones/desert.jpg',
    ...
    urban: {
        ...
        previewImage: ASSET_BASE + 'art/zones/urban.jpg',
    ...
    jungle: {
        ...
        previewImage: ASSET_BASE + 'art/zones/jungle.jpg',
    ...
    arctic: {
        ...
        previewImage: ASSET_BASE + 'art/zones/arctic.jpg',
