/* ═══════════════════════════════════════════════════════════════════
   weapons.data.js — the three player weapons, in switch order.
   Externalized from src/main.js (P0.2). See data/README.md for the
   content contract — JSON-literal only, no functions/imports.
   ═══════════════════════════════════════════════════════════════════ */
export default [
