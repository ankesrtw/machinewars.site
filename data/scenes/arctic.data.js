/* ═══════════════════════════════════════════════════════════════════
   arctic.data.js — scene config for "ARCTIC BASE".
...
export default {
    ...
    previewImage: "art/zones/arctic.jpg",
    sky: {
        type: "equirectangular",
        textureUrl: "skybox/arctic_sky.png",
        clearColor: [0.55, 0.62, 0.7, 1],
        fogColor: [0.55, 0.62, 0.7],
        fogDensity: 0.016,
        hasLightning: false,
        creon: {
    ...
    lighting: {
        ...
        ambientDiffuse: [0.7, 0.75, 0.82],
        ambientGround: [0.45, 0.5, 0.58],
        sunIntensity: 0.5,
        sunDiffuse: [0.8, 0.85, 0.9],
    ...
    propColors: {
        crate: [0.58, 0.65, 0.72],
        crateDark: [0.45, 0.52, 0.58],
        barrel: [0.5, 0.56, 0.62],
        barrelRust: [0.55, 0.42, 0.32],
        barrelGreen: [0.42, 0.52, 0.45],
        sandbag: [0.65, 0.7, 0.76],
        pole: [0.5, 0.56, 0.62],
        wire: [0.45, 0.5, 0.55],
    },
